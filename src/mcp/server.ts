...
═══════════════════════════════════════════════════════════════════════════
  ...
  • Posts are NOT localized — one English version only.
  • Slug is auto-generated from the title.
  • Categories and tags can be passed by name (looked up) or by ID. If a name
    doesn't exist, the tool errors — ask the user whether to use a different
    one.
