...
const RippleLink: React.FC<{ href: string; label: string }> = ({ href, label }) => {
  ...
  return (
    ...
    >
      ...
      <span className="relative inline-flex size-8 items-center justify-center rounded-full bg-white/15 text-white transition-transform duration-300 group-hover:translate-x-1 group-hover:bg-white/25">
